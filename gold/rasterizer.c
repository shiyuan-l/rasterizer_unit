...
{
  // START CODE HERE
  int floor_val = val >> (r_shift - ss_w_lg2);
  floor_val = floor_val << (r_shift - ss_w_lg2);
  return floor_val;
  // END CODE HERE
}
...
bool sample_test(Triangle triangle, Sample sample)
{
  ...
  dist2 = v2_x * v0_y - v0_x * v2_y;
  // test of origin is on right side
  b0 = dist0 <= 0.0;
  b1 = dist1 < 0.0;
  b2 = dist2 <= 0.0;
  // END CODE HERE
